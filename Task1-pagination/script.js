...
function changePage(page)
{
    ...
    for (var i = (page-1) * records_per_page; i < (page * records_per_page); i++) {
        table.innerHTML +=
        "<p><b>Pagination using DOM Manipulation</b></p><table id=\"table\" class=\"table table-bordered\"><tr><td>ID:</td><td>"+objJson[i].id+"</td></tr>"+
        "<tr><td>Name:</td><td>"+objJson[i].name+"</td></tr>" +
        "<tr><td>Email:</td><td>"+objJson[i].email+"</td></tr></table><br/>";
    }
    page_span.innerHTML = page;
    page_span1.innerHTML = page-1;
    if (page_span1.innerHTML <= 0) {
      page_span1.style.visibility = "hidden";
    } else {
      page_span1.style.visibility = "visible";
    }
    page_span2.innerHTML = page+1;
    if (page_span2.innerHTML >= 100) {
      page_span2.style.visibility = "hidden";
    } else {
      page_span2.style.visibility = "visible";
    }
